...
# Define MSCOCO classnames and templates
mscoco_classnames = [
...
mscoco_template = [
    ...
    lambda c: f'a bad photo of the {c}.',
    lambda c: f'a photo of many {c}.',
    lambda c: f'a photo of several {c} in the scene.',
    lambda c: f'a realistic depiction of a {c}.'
]

# Integrate these into the data_classnames and data_template dictionaries
data_classnames['mscoco'] = mscoco_classnames
data_template['mscoco'] = mscoco_template
